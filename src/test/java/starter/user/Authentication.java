...
public class Authentication {
    ...
    public void sendPostHttpForRegister(){
        ...
        requestBody.put("fullname", "Claudya Gracefull");
        requestBody.put("email", "claudyagrace@gmail.com");
    ...
    public void validateDataNewAccount(){
        restAssuredThat(response -> response.body("'data'.'Fullname'", equalTo("Claudya Gracefull")));
    }
